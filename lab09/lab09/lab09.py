...
def num_trees(n):
    ...
    *   *        *       *
    ...
    if n == 1:
        return 1
    return sum([num_trees(left) * num_trees(n - left) for left in range(1, n)])
...
class Keyboard:
    ...
    def press(self, info):
        ...
        if info in self.buttons:
                presskey = self.buttons[info]
                presskey.times_pressed = presskey.times_pressed + 1
                return presskey.key
        return ''
    ...
    def typing(self, typing_input):
        ...
        for typed in typing_input:
            output = output + self.press(typed)
        return output
