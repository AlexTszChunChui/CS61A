class VendingMachine:
    ...
    """
    "*** YOUR CODE HERE ***"
    def __init__(self, product, price, balance=0, stocks=0):
    ...
    def restock(self, amount):
        ...
        return 'Current {} stock: {}'.format(self.product, self.stocks)
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        yearpass = Mint.current_year - self.year
        if yearpass > 50:
            return self.cents + yearpass - 50
        return self.cents
...
def store_digits(n):
    ...
    n = n // 10
    while n:
        stored.first, stored.rest = n % 10, Link(stored.first, stored.rest)
        n = n // 10
    return stored
