...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    standard = make_city('', lat, lon)
    if distance(standard, city_a) < distance(standard, city_b):
...
def add_trees(t1, t2):
    ...
    """
    "*** YOUR CODE HERE ***"
    result_labels = label(t1) + label(t2)
    result_brnaches = []
    i = 0
    ...
    while i < min(len(branches(t1)), len(branches(t2))):
        ...
        result_brnaches = result_brnaches + [new_branch]
        i = i + 1
    result_brnaches = result_brnaches + branches(t1)[i:]
    result_brnaches = result_brnaches + branches(t2)[i:]
    return tree(result_labels, result_brnaches)
